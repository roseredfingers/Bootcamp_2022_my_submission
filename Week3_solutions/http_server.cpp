...
string HTTP_Response::get_string() {
  ...
  */
 string r = "";
 r = "HTTP/"+this->HTTP_version+" "+this->status_code+" "+this->status_text+"\r\n";
 r.append("Content-Length: "+this->content_length+"\r\n");
 r.append("Connection: "+this->connection+"\r\n");
 r.append("Content Type: "+this->content_type+"\r\n");
 r.append("\r\n");
 r.append(this->body);
 r.append("\r\n");
